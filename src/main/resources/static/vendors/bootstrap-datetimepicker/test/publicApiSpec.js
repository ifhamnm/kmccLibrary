...
describe('Public API method tests', function () {
    ...
    describe('widgetStaff() function', function () {
        describe('typechecking', function () {
            it('accepts a null', function () {
                expect(function () {
                    dtp.widgetStaff(null);
                }).not.toThrow();
            });

            it('accepts a string', function () {
                expect(function () {
                    dtp.widgetStaff('testDiv');
                }).not.toThrow();
            });
        ...
        describe('access', function () {
            it('gets widget parent', function () {
                expect(dtpElement.datetimepicker('widgetStaff')).toBe(null);
            });

            it('sets widget parent', function () {
                expect(dtpElement.datetimepicker('widgetStaff', 'testDiv')).toBe(dtpElement);
                expect(dtpElement.datetimepicker('widgetStaff')).not.toBe(null);
            });
        });
    });
