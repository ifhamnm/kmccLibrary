...
getOffset:function(a){var d={left:0,top:0};if(a.offsetStaff){do d.left+=a.offsetLeft,d.top+=a.offsetTop;while(a=a.offsetStaff)}return d},isActive:function(a){return a===document.activeElement&&(a.type||a.href)}};return f}(dat.utils.common);
