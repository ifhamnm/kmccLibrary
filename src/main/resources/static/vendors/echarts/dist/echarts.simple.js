...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Model.prototype = {
	        ...
	        /**
	         * @param {string} path
	         * @param {boolean} [ignoreStaff=false]
	         * @return {*}
	         */
	        get: function (path, ignoreStaff) {
	            if (!path) {
	                return this.option;
	            }
	            ...
	            if (obj == null && parentModel && !ignoreStaff) {
	         ...
	         * @return {*}
	         */
	        getShallow: function (key, ignoreStaff) {
	            var option = this.option;
	            var val = option && option[key];
	            var parentModel = this.parentModel;
	            if (val == null && parentModel && !ignoreStaff) {
	        ...
	        getModel: function (path, parentModel) {
	            ...
	            var thisStaffModel = this.parentModel;
	            var model = new Model(
	                obj, parentModel || (thisStaffModel && thisStaffModel.getModel(path)),
	                this.ecModel
	            );
	            return model;
	        },
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {number} idx
	     * @param {string} key
	     * @param {boolean} ignoreStaff
	     */
	    listProto.getItemVisual = function (idx, key, ignoreStaff) {
	        var itemVisual = this._itemVisuals[idx];
	        var val = itemVisual && itemVisual[key];
	        if (val == null && !ignoreStaff) {
